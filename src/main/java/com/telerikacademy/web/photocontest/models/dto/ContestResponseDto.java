...
public record ContestResponseDto(
        ...
        String coverPhoto, boolean isInvitational, Boolean isFinished, List<String> juries, List<String> participants, List<Photo> photos, List<ContestResultDto> results
) {}
